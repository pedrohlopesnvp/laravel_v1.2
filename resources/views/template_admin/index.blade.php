    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">Commerce Mazon</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesP" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/produto">Home</a>
                        <a class="collapse-item" href="/produto/novo">Inserir novo produto</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesM" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Opções:</h6>
                        <a class="collapse-item" href="/marca">Home</a>
                        <a class="collapse-item" href="/marca/novo">Inserir nova marca</a>
                        <!-- <a class="collapse-item active" href="blank.html">Blank Page</a> -->
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesC" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Opções:</h6>
                        <a class="collapse-item" href="/categoria">Home</a>
                        <a class="collapse-item" href="/categoria/novo">Inserir categoria</a>
                        <!-- <a class="collapse-item active" href="blank.html">Blank Page</a> -->
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesCor" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Opções:</h6>
                        <a class="collapse-item" href="/cor">Home</a>
                        <a class="collapse-item" href="/cor/novo">Inserir cor</a>
                        <!-- <a class="collapse-item active" href="blank.html">Blank Page</a> -->
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Pedro Henrique Lopes</span>
